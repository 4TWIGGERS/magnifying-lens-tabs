  ...
  <View style={[styles.absolute, styles.shadow]} pointerEvents='none'>
   <View style={[styles.absolute, styles.tabBarCommon]}>
    <Animated.View
     ...
     {withBlurryBG && <BlurView intensity={100} style={innerBlurStyle} />}
     {IS_IOS && (
      <>
      ...
      {tabs.map((label, index) => (
       <View key={index} style={styles.tab}>
        <Text
         ...
         onTextLayout={(event) => {
          const { text, width } = event.nativeEvent.lines[0];
...
const App = () => {
 ...
 return (
  <>
   ...
   <View style={styles.zoomContainerStyle}>
    <View style={styles.zoomStyle}>
     <View
      style={{
       flexDirection: 'row',
       alignItems: 'center',
      ...
      <TouchableOpacity
       onPress={() => zoomLevel > 1 && setZoomLevel((s) => s - 0.1)}
       style={{
        flex: 1,
        alignItems: 'center',
      ...
      <TouchableOpacity
       onPress={() => zoomLevel < 2 && setZoomLevel((s) => s + 0.1)}
       style={{
        flex: 1,
        alignItems: 'center',
        justifyContent: 'center',
